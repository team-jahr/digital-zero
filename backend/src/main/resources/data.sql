...
insert into issue values(1, 'Test1', '10.png,20.png', 'Warning', 'No proper shoes') on conflict (id) do nothing;
insert into issue values(2, 'Test2', '20.png,10.png', 'Warning', 'No proper shoes2') on conflict (id) do nothing;